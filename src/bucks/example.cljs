...
(def asset2
  [["open-asset" "Asset 2" last-year 5 15 "TFSA" 45000 0 "n"]
...
(def closed-asset
  [["open-asset" "Closed Asset 1" last-year 2 2 "Crypto" 100000 1 "n"]
   ["transaction" "Closed Asset 1" last-year 6 6 1000 120000 0.03]
   ["close-asset" "Closed Asset 1" last-year 9 9 130000]])

(def ignore-asset
  [["open-asset" "Ignored Asset 1" last-year 3 2 "Crypto" 200000 1 "y"]])
